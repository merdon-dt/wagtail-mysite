# Generated by Django 5.2.1 on 2025-07-11 09:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', models.CharField(blank=True, help_text='Text to describe the contact form', max_length=255)),
                ('thank_you_text', wagtail.fields.RichTextField(blank=True, help_text='Text to display to users after they submit the form', max_length=255)),
            ],
            options={
                'abstract': False,
            },
